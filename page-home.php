            ...
            <div class="block-services__container">
                ...
                <div class="services-tabs">
                    ...
                    <div class="mobile-content">
                        <?php foreach ($tab_list as $tab_mobile) { ?>
                            <div class="tab-mobile<?php if ($mobile_content == 0) { ?> active<?php } ?>">
                                <div class="tab-mobile__container">
                                    <div class="services-content__description-block">
                                        ...
                                        <div class="services-content__description"><?php echo $tab_mobile['services_tabs_content']['services_tabs_description']; ?></div>
                                    </div>
                                    <div class="tab-mobile__image-wrapper">
                                        <img class="tab-mobile__image"
                                             src="<?php echo $tab_mobile['services_tabs_content']['services_tabs_image']; ?>" alt="image">
                                    </div>
                                    <div class="tab-mobile__wrapper">
                                        <p class="tab-mobile__title"><?php echo $tab_mobile['services_tabs_title']; ?></p>
                                        <div class="tab-mobile__description">
                                            <div class="tab-mobile__text"><?php echo $tab_mobile['services_tabs_content']['services_tabs_text']; ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    (function ($) {
        ...
        if($(window).width() < 1200) {
            ...
            servicesTabs.on('click', function () {
                ...
                var currentTab = servicesMobileContent.eq($(this).attr('data-tab').replace('#tab', ''));
